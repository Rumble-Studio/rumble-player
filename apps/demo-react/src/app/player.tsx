...
import { RumblePlayerService, HTMLRumblePlayer, LinearBar, SimplePlayButton, GenericVisual } from '@rumble-player/rp';
...
export default class Player extends React.Component<IProps, IState>{
  ...
  componentDidMount = () => {
    ...
    (this.containerRef.current as HTMLDivElement).appendChild(this.playerHTML);
    console.log(this.containerRef.current as HTMLDivElement);
  ...
  render(){
    ...
    return(<div>
      <br />
      <button onClick={this.togglePlayer}>click me to toggle play/pause</button>
      <hr />
      <br />
      <br />
